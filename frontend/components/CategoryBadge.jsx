...
export default function CategoryBadge({ category, className = '' }) {
  ...
  return (
    <span
      className={`inline-flex max-w-full items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 text-xs font-bold text-emerald-800 ring-1 ring-emerald-100 ${className}`}
    >
